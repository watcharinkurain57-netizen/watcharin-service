...
--
-- ถ้า cascade แล้วลบโฟลเดอร์ = แถวใน project_files หายไปด้วย
-- แต่ **ไฟล์จริงใน Storage ไม่ได้หายตาม** เพราะ Postgres ไม่รู้จัก Storage
-- และหน้าเว็บรู้จักไฟล์ผ่านตารางนี้ทางเดียว
-- พอแถวหาย = ไฟล์นั้นค้างกินโควตาตลอดกาลโดยไม่มีใครมองเห็นและตามลบไม่ได้
--
-- set null แทน = ลบโฟลเดอร์แล้วไฟล์ข้างในย้ายออกมาอยู่ชั้นบนสุด ไม่มีอะไรหาย
