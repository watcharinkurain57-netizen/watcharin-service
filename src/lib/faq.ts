...
export const faq: FaqItem[] = [
              ...
              {
                q: "คิดราคายังไง?",
                a: "ประเมินเป็นรายโปรเจกต์ตามขอบเขตงานและความซับซ้อน — เริ่มจากปรึกษาฟรีก่อนเสมอ แล้วผมจะสรุปขอบเขตงานพร้อมราคาให้ชัดเจนก่อนเริ่ม ไม่มีค่าใช้จ่ายแอบแฝง สำหรับงานโรงงานมีราคาเริ่มต้นให้ดูเป็นกรอบงบแล้วที่หัวข้อ Industrial Solutions (Plan A เริ่มต้น 300,000 บาท) ราคาจริงขึ้นกับจำนวนไลน์ จำนวนจุดที่ต้องต่อ และระบบเดิมที่มีอยู่",
              },
              {
                q: "โปรเจกต์หนึ่งใช้เวลานานแค่ไหน?",
              ...
              },
              {
                ...
                a: "หลักๆ ผมดูแลเองแบบ end-to-end โดยใช้ AI ช่วยเร่ง workflow ทำให้ส่งงานได้เร็วและคุมคุณภาพได้ — สำหรับโปรเจกต์ใหญ่สามารถดึง partner/ผู้เชี่ยวชาญเฉพาะทางมาเสริมได้",
              },
              {
