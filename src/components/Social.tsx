...
const links = [
  {
    label: "GitHub",
    href: "https://github.com/watcharinkurain57-netizen",
    Icon: GitHubIcon,
    external: true,
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/watcharin-kurain-28bb593b1/",
    Icon: LinkedInIcon,
    external: true,
  },
  {
    ...
    <div className={`flex items-center gap-2 ${className}`}>
      {links.map(({ label, href, Icon, external }) => (
        <a
          ...
          className="w-9 h-9 rounded-lg bg-surface-raised border border-line flex items-center justify-center text-ink-faint hover:text-brand-400 hover:border-brand-400/50 hover:-translate-y-0.5 transition-all"
        >
