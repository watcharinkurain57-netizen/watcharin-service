...
import { getResume, type Lang } from "@/lib/resume-data";
import { PrintButton } from "@/components/PrintButton";

const ui = {
  th: {
    back: "← กลับหน้าหลัก",
    hint: "กดปุ่ม → เลือกปลายทางเป็น “บันทึกเป็น PDF”",
    save: "⬇ บันทึกเป็น PDF",
    font: "var(--font-ibm-thai), var(--font-inter), sans-serif",
  },
  en: {
    back: "← Back to home",
    hint: "Click → choose “Save as PDF” as the destination",
    save: "⬇ Save as PDF",
